...
net.W.bw_A = 1.0 * ones(w_num,1);    % A参数
net.W.bw_beta = 0.1 * ones(w_num,1); % beta参数
net.W.bw_gamma = 0.1 * ones(w_num,1);% gamma参数
net.W.bw_n = 1.0 * ones(w_num,1);    % n参数
net.W.bw_alpha = 0.5 * ones(w_num,1);% alpha参数
