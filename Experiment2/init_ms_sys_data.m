...
%  
% Hauser, H.; Ijspeert, A.; Fuhslin, R.; Pfeifer, R. & Maass, W.
...
d.k_lim  =[100 200; 0.1 1];     % k spring constants range
d.d_lim  =[100 200; 0.1 1];     % d damping constants range
...
d.readout_type = 'POSITIONS'; % type of readout - either POSITIONS or LENGTHS							
